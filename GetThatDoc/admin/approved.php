                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col s12 center">
                          <?php $sql = "select * from fileupload where approved=1";
                          $result = mysqli_query($link, $sql);
                          $num = mysqli_num_rows($result); ?>
                            <h4 class="light">Approved Notes (<?php echo $num ?>)</h4>
                        </div>
                    </div>
                        ...
                        <div class="col s12">
                            <ul class="collapsible popout">
                                    ...
                                    <?php                        
                                            ...
                                            $sql = "select * from fileupload where approved=1 ORDER BY `id` DESC";
                                            $result = mysqli_query($link,$sql);    
                                    ...
                                    <div class="collapsible-body">
                                        <div class="row">
                                            <div class="col s8 m6 center-align">     
                                                <p>
                                                    ...
                                                    <div class="switch"><b>Featured:</b><label>
                                        ...
                                        <div class="row">
                                            <div class="col s8 m6 center-align">                          
                                                ...
                                                <p>
                                                    <div class="name"><p><b>No of Downloads:</b>&nbsp;&nbsp;</p>
                                                        <p><?php echo "$row[downloads]";?></p>
                                                        <span class="lever"></span>
                                                    </div>
                                                </p>      
                                            </div>
                                        ...
                                        <div class="col s8 center-align">
                                            ...
                                            <div class="col s8 center-align">
                                                <a href="edit.php?q=<?php echo $row['id'];?>"><button class="btn edit" name="del">Edit</button></a>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function toggleApproved(id){
            ...
            $.ajax({
                ...
                data : {'id':id},
                success: function(e){
                    alert("Press OK to change status !!");
                    location.reload();
                }
            });
        }
